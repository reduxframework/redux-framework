		...
		public function render() {
			...
			foreach ( $shadow_arr as $idx => $shadow_type ) {
				if ( $this->field[ $shadow_type . '-shadow' ] ) {
					...
					echo esc_html( ucfirst( $shadow_type ) ) . ' ' . esc_html__( 'Shadow', 'redux-pro' );
					echo '</label>';
					echo '</li>';
					echo '<li>';
					...
					echo '<label>' . esc_html__( 'Horizontal Length ', 'redux-pro' ) . ':  <strong>' . esc_html( $this->value[ $shadow_type . '-shadow' ]['horizontal'] ) . 'px</strong></label>';
					echo '<div
                            ...
                            data-label="' . esc_attr__( 'Horizontal Length', 'redux-pro' ) . '"
					...
					echo '<label>' . esc_html__( 'Vertical Length ', 'redux-pro' ) . ':  <strong>' . esc_html( $this->value[ $shadow_type . '-shadow' ]['vertical'] ) . 'px</strong></label>';
					echo '<div
                                ...
                                data-step="1"
                                data-rtl="' . esc_attr( is_rtl() ) . '"
                                data-label="' . esc_attr__( 'Vertical Length', 'redux-pro' ) . '"
					...
					echo '<label>' . esc_html__( 'Blur Radius ', 'redux-pro' ) . ':  <strong>' . esc_html( $this->value[ $shadow_type . '-shadow' ]['blur'] ) . 'px</strong></label>';
					echo '<div
                                ...
                                data-step="1"
                                data-rtl="' . esc_attr( is_rtl() ) . '"
                                data-label="' . esc_attr__( 'Blur Radius', 'redux-pro' ) . '"
					...
					echo '<label>' . esc_html__( 'Spread ', 'redux-pro' ) . ':  <strong>' . esc_html( $this->value[ $shadow_type . '-shadow' ]['spread'] ) . 'px</strong></label>';
					echo '<div
                                ...
                                data-step="1"
                                data-rtl="' . esc_attr( is_rtl() ) . '"
                                data-label="' . esc_attr__( 'Spread', 'redux-pro' ) . '"
