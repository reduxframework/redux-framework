	...
	class Redux_Framework_sample_config {
		...
		**/
		...
		public function setSections() {
            ...
            $this->sections[] = array(
              'title' => __('Field Groups', 'redux-framework-demo'),
              ...
              'fields' => array(
                  array(
                      ...
                      'title' => __('Slide with most controls', 'redux-framework-demo'),
                      'subtitle' => __('Group any items together. Experimental. Use at your own risk.', 'redux-framework-demo'),
                      'groupname' => __('Slide', 'redux-framework-demo'), // Group name
                      'subfields' =>
                      array(
                          array(
            				  'id'=>'group-test-slide-title',
            				  'type' => 'text',
                          ...
                          array(
                              'id'=>'group-test-wp-media',
                              'type' => 'media',
                              'title' => __('Media Uploader', 'redux-framework-demo'),
                              'compiler' => 'true',
                              'mode' => false, // Can be set to false to allow any media type, or can also be set to any mime type.
                              'desc'=> __('Basic media uploader with disabled URL input field.', 'redux-framework-demo'),
                              'subtitle' => __('Upload any media using the WordPress native uploader', 'redux-framework-demo'),
                          ...
                          array(
                              'id'=>'group-test-switch-fold',
                              'type' => 'switch',
                              'required' => array('group-test-switch-custom','=','1'),
                              'title' => __('Switch - With Hidden Items (NESTED!)', 'redux-framework-demo'),
                              'subtitle'=> __('Also called a "fold" parent.', 'redux-framework-demo'),
                              'desc' => __('Items set with a fold to this ID will hide unless this is set to the appropriate value.', 'redux-framework-demo'),
                              'default' => 0,
                          ...
                          array(
                              'id'=>'group-test-patterns',
                              'type' => 'image_select',
                              'tiles' => true,
                              'required' => array('group-test-switch-fold','equals','0'),
                              'title' => __('Images Option (with pattern=>true)', 'redux-framework-demo'),
                              'subtitle'=> __('Select a background pattern.', 'redux-framework-demo'),
                              'default' 		=> 0,
                              'options' => $sample_patterns
