	...
	function render(){
		...
		**/
		...
		if (!empty($this->field['options'])) {
			...
			echo '<select'.$multi.' id="'.$this->args['opt_name'].'['.$this->field['id'].']'.$nameBrackets.'" data-placeholder="'.$placeholder.'" name="'.$this->args['opt_name'].'['.$this->field['id'].']'.$nameBrackets.'" class="redux-select-item'.$this->field['class'].'"'.$width.' rows="6">';
				echo '<option></option>';
