...
if( !class_exists( 'ReduxFramework_border' ) ) {
    ...
    class ReduxFramework_border extends ReduxFramework{ 
        ...
        public function render() {
            ...
            echo '<select original-title="' . __( 'Border size', 'redux-framework' ) . '" id="' . $this->field['id'] . '" name="' . $this->args['opt_name'] . '[' . $this->field['id'] . '][size]" class="tips redux-border-size mini' . $class . '" rows="6">';
            ...
            echo '<select original-title="' . __( 'Border style', 'redux-framework' ) . '" id="' . $this->field['id'] . '" name="' . $this->args['opt_name'] . '[' . $this->field['id'] . '][style]" class="tips redux-border-style' . $class . '" rows="6">';
