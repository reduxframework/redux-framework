    ...
    function render(){
		...
		if ($this->field['font-family'] === true):
            ...
            if ($this->field['color'] === true):
                ...
                echo '<div id="' . $this->field['id'] . '_color_picker" class="colorSelector typography-color"><div class="typography-element-title">'.__('Font Color','redux-framework').'</div><div style="background-color: '.$this->value['color'].'"></div></div>';
