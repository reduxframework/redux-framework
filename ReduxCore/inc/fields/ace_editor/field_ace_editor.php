...
if ( ! class_exists( 'ReduxFramework_ace_editor' ) ) {
	class ReduxFramework_ace_editor {
		...
		function render() {
			...
			$readonly = ( isset( $this->field['readonly'] ) && $this->field['readonly']) ? 'onkeypress="return false;"' : '';
			$block_copy = ( isset( $this->field['block_copy'] ) && $this->field['block_copy']) ? 'block-copy' : '';
			...
			<div class="ace-wrapper">
				...
				<pre id="<?php echo esc_attr($this->field['id']); ?>-editor" class="ace-editor-area <?php echo $block_copy; ?>" <?php echo $readonly; ?>><?php echo htmlspecialchars( $this->value ); ?></pre>
			</div>
		<?php
		}
