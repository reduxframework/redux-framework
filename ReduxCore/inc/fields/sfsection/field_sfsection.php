...
// Don't duplicate me!
    if ( ! class_exists( 'ReduxFramework_sfsection' ) ) {
         ...
         * @since       1.0.0
         */
        class ReduxFramework_sfsection {
            ...
            public function render() {
                ...
                if($is_start){
                    echo '<span class="sf-section-toggle el el-plus"></span>';
                }
                echo '</div>';
                if($is_start){
                    echo '<!-- start content--><div class="sf-section-content">';
                }
            ...
            public function enqueue() {
                if ( $this->parent->args['dev_mode'] ) {
                    wp_enqueue_style(
                        'redux-field-sfsection-css',
                        ReduxFramework::$_url . 'inc/fields/sfsection/field_sfsection.css',
                        array(),
                        time(),
                        'all'
                    );
