...
class Redux_CDN {
    ...
    private static function _cdn( $register = true, $handle, $src_cdn, $deps, $ver, $footer_or_media, $is_script = true ) {
        ...
        $tran_key  = ( $is_script ) ? '_script_cdn_is_up' : '_style_cdn_is_up';
                ...
                if ( class_exists( 'Redux_VendorSupport' ) ) {
                    ...
                    if ( ! self::is_enqueued( $handle, 'enqueued', $is_script ) ) {
                        ...
                        if ( self::$_parent->args['dev_mode'] ) {
                            $msg = __( 'If developing offline, please download and install the <a href="http://reduxframework.com/wp-content/uploads/2015/05/redux-vendor-support.zip">Redux Vendor Support plugin</a> to bypass the vendor CDN and avoid this warning.', 'redux-framework' );
                        }
